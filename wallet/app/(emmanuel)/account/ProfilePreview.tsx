...
export default function ProfilePreview() {
  const [profile, setProfile] = useState({ fullName: 'John Doe', bio: 'E-commerce enthusiast and admin of Vale Platform', avatar: '' })
      ...
      <div className="border border-gray-200 rounded-xl p-4 flex items-center justify-between">
        ...
        <div className="flex gap-8 text-sm">
          <div className="flex flex-col gap-1">
            ...
            <span className="font-semibold text-gray-900 flex items-center gap-1">📅 Jan, 2025</span>
          </div>
          <div className="flex flex-col gap-1">
